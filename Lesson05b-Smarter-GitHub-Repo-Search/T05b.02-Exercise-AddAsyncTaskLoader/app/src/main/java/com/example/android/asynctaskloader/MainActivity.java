...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Done (24) Initialize the loader with GITHUB_SEARCH_LOADER as the ID,
        // null for the bundle, and this for the context
    ...
    private void makeGithubSearchQuery() {
        ...
        // Done (20) Use putString with SEARCH_QUERY_URL_EXTRA as the key and the String value of
    ...
    public Loader<String> onCreateLoader(int id, final Bundle args) {
        ...
        // Done (4) Return a new AsyncTaskLoader<String> as an anonymous inner class with this as
    ...
    // Done (16) Override onLoaderReset as it is part of the interface we implement,
    // but don't do anything in this method
    @Override
