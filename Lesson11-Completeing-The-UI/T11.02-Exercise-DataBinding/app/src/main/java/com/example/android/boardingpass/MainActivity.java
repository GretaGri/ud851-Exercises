...
public class MainActivity extends AppCompatActivity {
    ...
    private void displayBoardingPassInfo(BoardingPassInfo info) {
        ...
        Timestamp boardingTime = info.boardingTime;
        Timestamp departureTime = info.departureTime;
        Timestamp arrivalTime = info.arrivalTime;
        SimpleDateFormat dateFormaterAM = new SimpleDateFormat("h:mm a");
        mBinding.textViewBoardingTime.setText(dateFormaterAM.format(boardingTime));
        mBinding.textViewDepartureTime.setText(dateFormaterAM.format(departureTime));
        mBinding.textViewArrivalTime.setText(dateFormaterAM.format(arrivalTime));
        ...
        SimpleDateFormat dateFormater = new SimpleDateFormat("h:mm");
        mBinding.textViewBoardingInCountdown.setText(dateFormater.format(minutesUntilBoarding));
    }
}
