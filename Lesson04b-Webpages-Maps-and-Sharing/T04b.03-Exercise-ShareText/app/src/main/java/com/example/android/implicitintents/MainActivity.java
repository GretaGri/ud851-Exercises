...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        ...
        String textToShare = "Trying sharing intent";
...
//                .show();
    ...
    private void shareText(String textShared) {
        ...
        String title = "Choose an app to share your text";
        ...
        Intent intent = ShareCompat.IntentBuilder.from(MainActivity.this).
                ...
                setType(mimeType).
                setText(textShared).createChooserIntent();
