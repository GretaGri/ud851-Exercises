...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        loadShapeSizeFromPreferences(sharedPreferences);
    ...
    private void loadShapeSizeFromPreferences(SharedPreferences sharedPreferences) {
        mVisualizerView.setMinSizeScale(Float.parseFloat(sharedPreferences.getString(getString(R.string.pref_edit_size_key),
                getString(R.string.pref_edit_size_default_value))));
    }
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        if (key.equals(getString(R.string.pref_show_bass_key))) {
            ...
            loadColorFromPreferences(sharedPreferences);
        }else if (key.equals(getString(R.string.pref_edit_size_key))) {
            loadShapeSizeFromPreferences(sharedPreferences);
        }
    }
